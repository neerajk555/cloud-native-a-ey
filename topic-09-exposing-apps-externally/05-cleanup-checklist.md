# Topic 09 Cleanup Checklist: Exposing Apps Externally
...
- [ ] Confirmed in the AWS Console (EC2 > Load Balancers) that NO load balancer for your namespace remains - check by name/recency, not just by tag, since an untagged ALB won't show up in a tag search
