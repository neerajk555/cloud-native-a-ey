# Topic 10 Cleanup Checklist: Config and Secrets
...
- [ ] `kubectl get all,configmap,secret` in your namespace shows nothing left from this topic (aside from the default kubernetes ConfigMap/Secrets that always exist)
