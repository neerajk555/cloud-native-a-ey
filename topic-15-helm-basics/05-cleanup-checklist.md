# Topic 15 Cleanup Checklist: Helm Basics
...
- [ ] `helm list` in your namespace shows nothing left from this topic
- [ ] `kubectl get all` in your namespace confirms no orphaned resources
